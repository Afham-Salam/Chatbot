...
export default function Signup() {
  ...
  return (
    ...
    <div className="w-full    text-white flex justify-between px-6 py-1">
      <p>Logo</p>
      <Link to={'/login'} className="bg-white text-black  hover:opacity-80 px-3 py-1 rounded-md font-semibold">Login</Link>
    </div>
  ...
  <h1 className="lg:text-[5rem] font-extrabold fontStyle tracking-wider lg:block hidden">Welcome!</h1>
