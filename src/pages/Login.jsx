...
export default function Login() {
  ...
  return (
    ...
    <div className=" flex flex-col bg-black bg pt-1">
      <div className="w-full    text-white flex justify-between px-6 py-1">
            <p>Logo</p>
            <Link to={'/signup'} className="bg-white text-black  hover:opacity-80 px-3 py-1 rounded-md font-semibold">Signup</Link>
          </div>
  ...
  <h1 className="lg:text-[75px] font-extrabold fontStyle tracking-wider lg:block hidden">Welcome Back!</h1>
        ...
        {({ isSubmitting }) => (
          <Form className="md:p-10 p-7 border-2 border-opacity-45 rounded-lg border-gray-300 shadow-lg">
            ...
            <button
              ...
              type="button"
            >
              <img src="/google.webp" alt="Google Logo" className="w-6 h-6" />
